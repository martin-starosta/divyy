import { sum, clamp } from "../utils/MathUtils";
import type { DividendEvent, Fundamentals } from "../models/StockData";
import type { AnnualDividendData } from "../models/DividendAnalysis";
